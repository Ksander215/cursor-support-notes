...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("step_name", sa.String(), nullable=False),  # e.g. "ssl", "headers", "ports", "web_vulnerabilities", "report"
        sa.Column("step_status", sa.String(), nullable=False),  # "pending", "running", "completed", "failed"
        ...
        sa.ForeignKeyConstraint(["audit_id"], ["audits.id"], name="fk_scan_progress_audit_id_audits"),
