...
class RoadmapParser:
    ...
    def parse(self) -> list[dict]:
        ...
        for section_match in sections:
            ...
            next_section = re.search(r"#### \d+\.\d+", content[start_pos:], re.MULTILINE)
            ...
            if tasks_in_section:
                ...
                body = self._create_issue_body(
                    section_title, requirements, tasks_in_section, estimate, status, section_content
                )
    ...
    def _create_issue_body(
        ...
        body_parts.append("---")
        body_parts.append("*Создано автоматически из [roadmap](UPGRADE_ROADMAP.md)*")
...
def main():
    ...
    for task in tasks:
        ...
        issue = github.create_issue(title=task["title"], body=task["body"], labels=task["labels"])
